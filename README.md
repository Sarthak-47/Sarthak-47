...
|---|---|---|
| [**ARGUS**](https://github.com/Sarthak-47/ARGUS) | AI-powered security audit tool. Combines static analysis (rule-based scanning, dependency auditing, secret detection) with a 16-agent live exploit engine covering SQL injection, XSS, SSRF, IDOR, auth flaws, and business-logic abuse, plus LLM-generated fix patches. Ships as a CLI with SARIF output and a GitHub Action for CI security gating, alongside a Tauri/React desktop GUI. | Python, TypeScript, Tauri |
| [**Mimir**](https://github.com/Sarthak-47/Mimir) | Offline-first AI study agent with a hybrid RAG pipeline — BM25 and vector search fused via Reciprocal Rank Fusion, reranked by a cross-encoder (ms-marco-MiniLM). ReAct agent loop, 7 teaching modes, SM-2 spaced repetition, and Ebbinghaus decay grade prediction. 127-test CI suite with cross-platform installers (Windows/macOS/Linux). | Tauri, React, FastAPI, Ollama, ChromaDB |
| [**APEX**](https://github.com/Sarthak-47/Apex-Workspace) | Local-first hybrid IDE and agentic coding assistant running fully on local hardware via Ollama. Self-updating knowledge graph built from codebase embeddings and local vector search persists project context across sessions. Ships 5 AI agents (Coder, Reviewer, Explainer, Debugger, Test Writer) with approval-gated tool use and MCP server support. | Tauri 2, Rust, React 19, TypeScript |
| [**Rydex**](https://github.com/Sarthak-47/Rydex) | AI-powered parametric insurance platform for gig workers — Random Forest risk scoring, Isolation Forest anomaly detection, and DBSCAN fraud-ring clustering. A 5-signal Authenticity Score engine drives zero-touch payouts with sub-5-minute disruption-to-payout latency. Containerized microservices. Built at the Guidewire DEVTrails 2026 Hackathon. | FastAPI, scikit-learn, PostgreSQL, Next.js |
| [**GearGuard**](https://github.com/Sarthak-47/GearGaurd-OdooxAdani) | Full-stack maintenance management platform connecting equipment monitoring, service requests, and maintenance teams. Relational schema modeling assets, tickets, and technicians, with role-separated dashboards and REST APIs backing request creation, assignment, and status tracking. | JavaScript, Node.js, Express.js |
...
<img height="165" src="https://github-readme-stats-sigma-five.vercel.app/api?username=Sarthak-47&show_icons=true&count_private=true&hide_border=true&theme=dark" alt="GitHub Stats" />
<img height="165" src="https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=Sarthak-47&layout=compact&hide_border=true&theme=dark" alt="Top Languages" />
